  ...
  <section>
    ...
    <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
      <el-form :inline="true" :model="filters">
        ...
        <!--</el-form-item>-->
        <el-form-item>
          <router-link :to="'/classMes'" style="background-color: #717AD2;color: #f4f4f4;padding: 10px;border-radius:5px;">新增</router-link>
        </el-form-item>
      </el-form>
    </el-col>

    <!--列表-->
    <el-table :data="getClassInfoList" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
      <el-table-column type="selection" width="55">
      </el-table-column>
      <el-table-column type="index" width="60">
      </el-table-column>
      <el-table-column prop="classNum" width="120" label="班级编号" sortable>
      </el-table-column>
      <el-table-column prop="theTime" width="120" label="获取时间" sortable>
      </el-table-column>
      <el-table-column prop="classContent" label="原因" sortable>
      </el-table-column>
...
<script>
    ...
    import {getClassInfoList, removeStuInfo, batchRemoveStu, editClassInfo} from '../../api/api';
    ...
    export default {
        ...
        computed: {
            getClassInfoList: function () {
                ...
                var v = data.filter(function (p) {
                    return (p.classNum && p.classNum.indexOf(keyword) !== -1)
                        || (p.theTime && p.theTime.indexOf(keyword) !== -1)
                        || (p.classContent && p.classContent.indexOf(keyword) !== -1);
                });
                self.total = v.length;
        ...
        methods: {
            ...
            getInfos() {
                ...
                //获取数据接口
                getClassInfoList(para).then((response) => {
                    var d = response.data;
                    if (d && d.code === 'SUCCESS') {
